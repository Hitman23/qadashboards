...
class FormController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'add-entry'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionView($id)
    {
        ...
        $providerEntry = new \yii\data\ArrayDataProvider([
    ...
    /**
     *
     * Export Form information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    */
    public function actionAddEntry()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Entry');
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formEntry', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
